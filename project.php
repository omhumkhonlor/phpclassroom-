  ...
  <header>
    ...
    <div class="d-flex justify-content-end">
      <div class="card mb-3" style="max-width: 540px;">
        <div class="row g-0">
          <div class="col-md-4">
            <img src="D901D59C-49E3-4071-839A-660B320F6C25.jpeg" class="img-fluid rounded-start" alt="...">
          </div>
          <div class="col-md-8">
            <div class="card-body">
              <h5 class="card-title">จัดทำโดย</h5>
              <p class="card-text">นายปุณยวีร์ หนูแย้ม</p>
              <p class="card-text"><small class="text-muted">ม.6/13 เลขที่ 6 , 55787</small></p>
            </div>
          </div>
        </div>
      </div>
